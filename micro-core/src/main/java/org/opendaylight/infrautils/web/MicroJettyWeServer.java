 ...
 */
@Singleton
public class MicroJettyWeServer implements WebServer {

    private static final Logger LOG = LoggerFactory.getLogger(MicroJettyWeServer.class);
    ...
    public MicroJettyWeServer() {
        this(HTTP_SERVER_PORT);
    }

    public MicroJettyWeServer(final int httpPort) {
